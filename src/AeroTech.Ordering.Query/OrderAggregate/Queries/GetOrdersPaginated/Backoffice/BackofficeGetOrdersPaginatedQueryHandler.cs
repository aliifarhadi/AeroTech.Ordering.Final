...
namespace AeroTech.Ordering.Query.OrderAggregate.Queries.GetOrdersPaginated.Backoffice
{
        ...
        : IRequestHandler<BackofficeGetOrdersPaginatedQuery, GridData<OrderPaginatedRowDto>>
    {
        ...
        public BackofficeGetOrdersPaginatedQueryHandler(OrderQueryDbContext dbContext, IReferenceCodeReader codes)
        {
            _dbContext = dbContext;
            _codes = codes;
        }

        public async Task<GridData<OrderPaginatedRowDto>> Handle(
            ...
            CancellationToken cancellationToken)
        {
            ...
            var rows = from order in _dbContext.Orders.AsNoTracking()
                       ...
                       where (query.OrderReference == null || order.OrderReference == query.OrderReference)
                             ...
                             && (query.CustomerId == null || order.CustomerId == query.CustomerId)
