...
namespace AeroTech.Ordering.ReferenceData.Api
{
    ...
    public sealed class ReferenceSyncController : ControllerBase
    {
        ...
        private readonly TravelAgencySyncer _travelAgencySyncer;
        private readonly TravelAgencyOfficeSyncer _travelAgencyOfficeSyncer;
        ...
        public ReferenceSyncController(
            ...
            TravelAgencySyncer travelAgencySyncer,
            TravelAgencyOfficeSyncer travelAgencyOfficeSyncer)
        {
            ...
            _travelAgencySyncer = travelAgencySyncer;
            _travelAgencyOfficeSyncer = travelAgencyOfficeSyncer;
        }
        ...
        [HttpPost("AirlineOffices")]
        public async Task<IActionResult> SyncAirlineOffices(CancellationToken cancellationToken)
        {
            await _airlineOfficeSyncer.SyncAsync(cancellationToken);
            return Ok();
        }

        [HttpPost("TravelAgencies")]
        public async Task<IActionResult> SyncTravelAgencies(CancellationToken cancellationToken)
        {
            await _travelAgencySyncer.SyncAsync(cancellationToken);
            return Ok();
        }

        [HttpPost("TravelAgencyOffices")]
        public async Task<IActionResult> SyncTravelAgencyOffices(CancellationToken cancellationToken)
        {
            await _travelAgencyOfficeSyncer.SyncAsync(cancellationToken);
            return Ok();
        }
    }
}
